if (NOT TARGET SDL2_mixer)
    if (WIN32)  # Windows
        if (CMAKE_CXX_COMPILER_ID MATCHES "MSVC" OR
            ...
            set(SDL2_MIXER_DYNAMIC_LIB_DIR "${SDL2_MIXER_ROOT}/lib/x64" CACHE PATH "SDL2_mixer directory")
        ...
        elseif (CMAKE_CXX_COMPILER_ID MATCHES "GNU" OR
            ...
            set(SDL2_MIXER_DYNAMIC_LIB_DIR "${SDL2_MIXER_ROOT}/x86_64-w64-mingw32/bin" CACHE PATH "SDL2_mixer directory")
