    ...
    if (WIN32)  # Windows
        ...
        if (${is_msvc_backend}) # use MSVC
            ...
            if (${is_x64_compiler})
                ...
                set(SDL_MIXER_DYNAMIC_LIB_DIR "${SDL2_MIXER_ROOT}/lib/x64" CACHE PATH "SDL2_mixer directory" FORCE)
            else()
                set(LIB_DIR "${SDL2_MIXER_ROOT}/lib/x86")
                set(SDL_MIXER_DYNAMIC_LIB_DIR "${SDL2_MIXER_ROOT}/lib/x86" CACHE PATH "SDL2_mixer directory" FORCE)
            endif()
        ...
        elseif (${is_mingw_backend}) # use MINGW
            if (${is_x64_compiler})
                ...
                set(SDL_MIXER_DYNAMIC_LIB_DIR "${SDL2_MIXER_ROOT}/x86_64-w64-mingw32/bin" CACHE PATH "SDL2_mixer directory" FORCE)
            else()
                set(INCLUDE_DIR "${SDL2_MIXER_ROOT}/i686-w64-mingw32/include")
                set(STATIC_LIB_DIR "${SDL2_MIXER_ROOT}/i686-w64-mingw32/lib")
                set(SDL_MIXER_DYNAMIC_LIB_DIR "${SDL2_MIXER_ROOT}/i686-w64-mingw32/bin" CACHE PATH "SDL2_mixer directory" FORCE)
            endif()
