 ...
 */
TSNode ts_node_child_by_field_name(TSNode self, const char *field_name,
...
const TSQueryPredicateStep *ts_query_predicates_for_pattern(
    const TSQuery *self, uint32_t pattern_index, uint32_t *length);
 ...
 */
const char *ts_query_capture_name_for_id(const TSQuery *, uint32_t id,
                                         uint32_t *length);
 ...
 */
TSQuantifier ts_query_capture_quantifier_for_id(const TSQuery *,
                                                uint32_t pattern_id,
                                                uint32_t capture_id);

const char *ts_query_string_value_for_id(const TSQuery *, uint32_t id,
                                         uint32_t *length);
 ...
 */
bool ts_query_cursor_next_capture(TSQueryCursor *, TSQueryMatch *match,
 ...
 */
TSFieldId ts_language_field_id_for_name(const TSLanguage *, const char *,
                                        uint32_t);
